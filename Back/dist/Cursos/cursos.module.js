...
exports.CursosModule = CursosModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: curso_schema_1.Curso.name, schema: curso_schema_1.CursoSchema }])],
        controllers: [cursos_controller_1.CursosController],
        providers: [cursos_service_1.CursosService, app_gateway_1.AppGateway],
    })
], CursosModule);
